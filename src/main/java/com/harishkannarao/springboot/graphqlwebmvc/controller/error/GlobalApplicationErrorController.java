...
@Controller
public class GlobalApplicationErrorController extends BasicErrorController {
    ...
    @Autowired
    public GlobalApplicationErrorController(ErrorAttributes errorAttributes, List<ErrorViewResolver> errorViewResolvers) {
